...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/sie/api/enrollments/json/list/' . lpk(),
    'buttons' => array(),
    'cols' => array(
...
$card = $bootstrap->get_Card("card-view-service", array(
    ...
    "header-back" => $back,
    "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Registrations.message-list-title'), "message" => lang('Enrollments.message-list-description')),
    "content" => $table,
));
echo($card);
?>
