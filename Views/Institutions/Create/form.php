...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 09:25:42
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Institutions\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["institution"] = $f->get_Value("institution", pk());
...
$card = $b->get_Card("create", array(
    "title" => lang("Institutions.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
