...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2024-07-08 08:08:16
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Orders\Items\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    ...
    'cols' => array(
        'item' => array('text' => lang('App.item'), 'class' => 'text-center'),
        ...
        'amount' => array('text' => lang('App.amount'), 'class' => 'text-center'),
        'description' => array('text' => lang('App.description'), 'class' => 'text-center'),
        'percentage' => array('text' => lang('App.percentage'), 'class' => 'text-center'),
