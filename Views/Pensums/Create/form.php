...
$r["weekly_hourly_intensity"] = $f->get_Value("weekly_hourly_intensity");
$r["monthly_hourly_intensity"] = $f->get_Value("monthly_hourly_intensity");
...
$card = $b->get_Card("create", array(
    "title" => lang("Pensums.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
