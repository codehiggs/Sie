...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 10:27:58
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Programs\Delete\form.php]
...
$r = $model->where('program', $oid)->first();
$name = urldecode($r["name"]);
$message = sprintf(lang("Sie_Programs.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Sie_Programs.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Sie_Programs.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
