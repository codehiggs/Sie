...
if ($authentication->get_LoggedIn()) {
    ...
    $shortcuts->add($bootstrap->get_Shortcut(array("href" => "/sie/orders/list/" . lpk(), "icon" => ICON_PRODUCTS, "value" => "Ordenes", "description" => "Listado")));
    $shortcuts->add($bootstrap->get_Shortcut(array("href" => "#", "icon" => ICON_DISCOUNTS, "value" => "Créditos", "description" => "Listado")));
    echo($shortcuts);
} else {
