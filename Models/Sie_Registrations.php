 ...
 */
class Sie_Registrations extends Model
{
    ...
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                ...
                'place_of_residence' => ['type' => 'VARCHAR', 'constraint' => 254, 'null' => FALSE],
                ...
                'place_of_birth' => ['type' => 'VARCHAR', 'constraint' => 254, 'null' => FALSE],
...
//$forge->addKey('profile');
    ...
    public function get_List(int $limit, int $offset, string $search = ""): array|false
    {
        $result = $this
            ...
            ->orLike("date_of_birth", "%{$search}%")
            ->orLike("address", "%{$search}%")
            ->orLike("place_of_residence", "%{$search}%")
    ...
    public function get_RegistrationByTicket($ticket): false|array
    {
     ...
     * @return array|false
     */
    public function get_Registration($registration): false|array
    {
    ...
    public function get_RegistrationByIdentification($identification_number): false|array
    {
