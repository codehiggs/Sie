 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Registrations\List\index.php]
...
$data['permissions'] = array('singular' => false, "plural" => 'sie-registrations-view-all');
...
if ($plural) {
    if (!empty($submited)) {
        $json = array(
            ...
            'right' => get_sie_help_registrations(),
            "main_template" => "c8c4",
        );
    } else {
        $json = array(
