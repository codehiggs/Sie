...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 09:47:03
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Modules\Editor\validator.php]
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Modules.view-errors-title"));
    $smarty->assign("message", lang("Modules.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "sie/modules-view-errors-message.mp3");
