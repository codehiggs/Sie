...
//[groups]--------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("fields" => $f->fields["alias"] . $f->fields["firstname"] . $f->fields["lastname"]));
...
$card = $bootstrap->get_Card("card-view-service", array(
    ...
    "header-back" => $back,
    "header-edit" => "/sie/teachers/edit/" . $oid,
    "content" => $f,
));
echo($card);
?>