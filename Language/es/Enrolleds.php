...
return [
    ...
    "help_enrolled" => "enrolled",
    "help_course" => "course",
    "help_student" => "student",
    "help_status" => "status",
    "help_author" => "author",
    ...
    "delete-message" => "Para confirmar la eliminación de la matricula <b>%s</b>, presioné eliminar, para retornar al listado general de #plural presioné cancelar.",
    ...
    "delete-success-message" => "La matricula se elimino exitosamente, para retornar al listado de general de #plural presioné el botón continuar en la parte inferior de este mensaje.",
    // - Enrolleds list
