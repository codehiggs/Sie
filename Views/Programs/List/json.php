 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Programs\List\json.php]
...
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/sie/programs';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["program"]}";
    $editor = "{$component}/edit/{$item["program"]}";
    $deleter = "{$component}/delete/{$item["program"]}";
    ...
    //[preregistration]-------------------------------------------------------------------------------------------------
    $item["preregistration"] = $item["preregistration"] == "Y" ? lang("App.Yes") : lang("App.No");
    //[Fields]----------------------------------------------------------------------------------------------------------
    ...
    $row["preregistration"] = $item["preregistration"];
