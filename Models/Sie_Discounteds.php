...
/**
 * @syntax: $mdiscounteds = model("App\Modules\Sie\Models\Sie_Discounteds");
 * @method where(mixed $primaryKey, string $id) : \Higgs\Database\BaseBuilder
 * @method groupStart() : \Higgs\Database\BaseBuilder
 */
class Sie_Discounteds extends Model
{
    protected $table = "sie_discounteds";
    ...
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                'discounted' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
