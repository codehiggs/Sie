...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Sie_Programs.view-errors-title"));
    $smarty->assign("message", lang("Sie_Programs.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "sie/programs-view-errors-message.mp3");
