...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Spaces.view-success-title"),
        'text' => lang("Spaces.view-success-message"),
    ...
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Spaces.view-noexist-title"),
        'text' => lang("Spaces.view-noexist-message"),
        'footer-class' => 'text-center',
