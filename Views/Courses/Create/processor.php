 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Courses\Creator\processor.php]
...
if (is_array($row)) {
    $c = $card = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Courses.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Courses.create-duplicate-message"),
    ...
    $c = $card = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Courses.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Courses.create-success-message"), $d['course']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
