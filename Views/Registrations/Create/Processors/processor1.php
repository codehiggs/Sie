...
$d = array(
    ...
    "agreement" => "66ABB51FA8F49",
    "agreement_country" => $f->get_Value("country"),
    "agreement_region" => $f->get_Value("region"),
    "agreement_city" => $f->get_Value("city"),
...
$row = $mregistrations->get_Registration($d["registration"]);
