...
$f = service("forms", array("lang" => "Pensums."));
//[Request]-----------------------------------------------------------------------------
$row = $model->find($oid);
$r["pensum"] = $row["pensum"];
...
$r["hourly_intensity"] = $row["hourly_intensity"];
...
$f->fields["hourly_intensity"] = $f->get_FieldView("hourly_intensity", array("value" => $r["hourly_intensity"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["pensum"] . $f->fields["reference"] . $f->fields["program"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["module"] . $f->fields["level"] . $f->fields["credits"])));
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["weekly_hourly_intensity"] . $f->fields["hourly_intensity"] . $f->fields["evaluation"])));
