 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Spaces\Delete\form.php]
...
$r = $model->get_Spaces($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Spaces.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Spaces.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Spaces.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
