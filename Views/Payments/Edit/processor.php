...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Payments.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Payments.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Payments.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Payments.edit-noexist-message"), $d['payment']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
