...
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        ...
        "title" => lang("Agreements.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Agreements.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Agreements.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Agreements.create-success-message"), $d['agreement']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
