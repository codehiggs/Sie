...
//[services]------------------------------------------------------------------------------------------------------------
$b = service("bootstrap");
$f = service("forms", array("lang" => "Sie_Students."));
//[models]--------------------------------------------------------------------------------------------------------------
...
$f->fields["alias"] = $f->get_FieldAlias("alias", array("value" => $r["alias"], "proportion" => "col-xl-4 col-md-12 col-12", "readonly" => true));
...
$card = $b->get_Card("create", array(
    "title" => lang("Students.create-title"),
    "content" => $f,
));
echo($card);
$femail = $f->get_FieldId("email");
$falias = $f->get_FieldId("alias");
?>
<script>
    document.getElementById('<?php echo($femail);?>').addEventListener('input', function (e) {
        var email = e.target.value;
        var alias = email.substring(0, email.lastIndexOf("@"));
        document.getElementById('<?php echo($falias);?>').value = alias;
    });
</script>