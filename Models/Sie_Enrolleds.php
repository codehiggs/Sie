 ...
 */
class Sie_Enrolleds extends Model
{
    protected $table = "sie_enrolleds";
    protected $primaryKey = "enrolled";
    ...
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                'enrolled' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'course' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'student' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'status' => ['type' => 'ENUM', 'constraint' => ['ACTIVE', 'DESERTED', 'RETIRED', 'WITHDRAWN', 'ENROLLED', 'PENDING', 'GRADUATED', 'ABSENT', 'ONHOLD', 'SUSPENDED', 'EXPULLED', 'REINSTATED'], 'default' => 'ENROLLED',],
