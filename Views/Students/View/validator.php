 ...
 * █ ---------------------------------------------------------------------------------------------------------------------
 **/
$f = service("forms", array("lang" => "Security.users-"));
/*
* -----------------------------------------------------------------------------
* [Request]
* -----------------------------------------------------------------------------
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Security.users-view-errors-title"));
    $smarty->assign("message", lang("Security.users-view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "security/users-view-errors-message.mp3");
