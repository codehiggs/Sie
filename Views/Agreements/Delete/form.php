...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-06 15:45:07
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Agreements\Delete\form.php]
...
$r = $model->get_Agreement($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Agreements.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Agreements.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Agreements.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
