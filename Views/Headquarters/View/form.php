...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 09:20:50
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Headquarters\Editor\form.php]
...
$f = service("forms", array("lang" => "Sie_Headquarters."));
//[Request]-----------------------------------------------------------------------------
$row = $model->get_Headquarters($oid);
...
$back = "/sie/headquarters/list/" . lpk();
//[Fields]-----------------------------------------------------------------------------
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/sie/headquarters/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["headquarter"] . $f->fields["name"] . $f->fields["description"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["address"] . $f->fields["phone"] . $f->fields["author"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Headquarters.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
