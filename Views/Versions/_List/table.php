...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2024-04-24 12:58:28
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Versions\List\table.php]
...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/sie/api/versions/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' =>ICON_ADD,'text'=>lang('App.Create'), 'href' => '/sie/versions/create/'.lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'version' => array('text' => lang('App.version'), 'class' => 'text-center'),
        'grid' => array('text' => lang('App.grid'), 'class' => 'text-center'),
...
$card = $bootstrap->get_Card("card-view-service", array(
	 "title" => lang('Versions.list-title'),
	 "header-back" => $back,
	 "alert" => array("icon" => ICON_INFO, "type" => "info", "title" => lang('Versions.list-title'), "message" => lang('Versions.list-description')),
	 "content" => $table,
));
echo($card);
?>
