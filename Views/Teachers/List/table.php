...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/sie/api/teachers/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/sie/teachers/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
        'user' => array('text' => lang('App.User'), 'class' => 'text-start no-wrap', 'visible' => false),
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Teachers.list-title'),
    "header-back" => $back,
    "alert" => array(
        'type' => 'info',
        'title' => lang('App.Remember'),
        'message' => lang("Teachers.rol-info")
    ),
    "content" => $table,
));
echo($card);
