...
$l["back"] = "/sie/versions/view/{$d["version"]}";
$l["edit"] = "/sie/pensums/edit/{$d["pensum"]}";
$asuccess = "sie/pensums-edit-success-message.mp3";
$anoexist = "sie/pensums-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
    $edit = $model->update($d['pensum'], $d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Pensums.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Pensums.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Pensums.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Pensums.edit-noexist-message"), $d['pensum']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
