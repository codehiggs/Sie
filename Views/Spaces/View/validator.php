...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-07-18 11:19:02
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Spaces\Creator\validator.php]
...
//$f->set_ValidationRule("headquarters","trim|required");
...
//$f->set_ValidationRule("static_capacity","trim|required");
//$f->set_ValidationRule("dynamic_capacity","trim|required");
//$f->set_ValidationRule("tv","trim|required");
//$f->set_ValidationRule("split_wall","trim|required");
//$f->set_ValidationRule("split_ceiling","trim|required");
//$f->set_ValidationRule("videobeam","trim|required");
//$f->set_ValidationRule("sound","trim|required");
