...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Registrations.view-success-title"),
        'text' => lang("Registrations.view-success-message"),
    ...
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Registrations.view-noexist-title"),
        'text' => lang("Registrations.view-noexist-message"),
        'footer-class' => 'text-center',
