...
//[Variables]-----------------------------------------------------------------------------------------------------------
$registration = $model->get_Registration($oid);
...
$fecha = "20240717";//Fecha maxima de pago $dateTime->format('Ymd');
//[pdf]-----------------------------------------------------------------------------------------------------------------
$pdf = new Fpdi();
$pdf->AddPage();
...
foreach ($discounteds as $discounted) {
    $discount = $mdiscounts->get_Discount($discounted['discount']);
    $y = $y + 4;
    $x = $tx;
