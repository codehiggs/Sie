 ...
 *
 */
class Students extends ModuleController
{
    ...
    {
        $url = base_url('sie/students/home/' . lpk());
    ...
    public function view(string $oid)
    {
        ...
        $this->component = $this->views . '\Students\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd)
    {
        ...
        $this->component = $this->views . '\Students\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd)
    {
        ...
        $this->component = $this->views . '\Students\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function importer(string $rnd)
    {
        ...
        $this->component = $this->views . '\Students\Importer';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid)
    {
        ...
        $this->component = $this->views . '\Students\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Students\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
