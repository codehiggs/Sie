 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Discounts\Creator\form.php]
...
$card = $b->get_Card("create", array(
    "title" => lang("Discounts.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
