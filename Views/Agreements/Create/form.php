...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-06 15:42:44
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Agreements\Creator\form.php]
...
//[models]--------------------------------------------------------------------------------------------------------------
$magreement = model("App\Modules\Sie\Models\Sie_Agreements");
$minstitutions = model("App\Modules\Sie\Models\Sie_Institutions");
//[vars]----------------------------------------------------------------------------------------------------------------
$r["agreement"] = $f->get_Value("agreement", pk());
...
$r["headquarters"] = $f->get_Value("headquarters");
...
$institutions = $minstitutions->get_SelectData();
$data = array();
$default = array(
    array("value" => "", "label" => "Seleccione una institución")
);
$data = array_merge($default, $institutions);
//[fields]----------------------------------------------------------------------------------------------------------------
$f->add_HiddenField("back", $back);
$f->fields["agreement"] = $f->get_FieldText("agreement", array("value" => $r["agreement"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12", "readonly" => "readonly"));
...
$f->fields["institution"] = $f->get_FieldSelect("institution", array("selected" => $r["institution"], "data" => $data, "proportion" => "col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12"));
$f->fields["headquarters"] = $f->get_FieldText("headquarters", array("value" => $r["headquarters"], "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12"));
$f->fields["resolution"] = $f->get_FieldText("resolution", array("value" => $r["resolution"], "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["agreement"])));
...
$f->groups["g5"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["headquarters"] . $f->fields["resolution"])));
//[buttons]-------------------------------------------------------------------------------------------------------------
$f->groups["gy"] = $f->get_GroupSeparator();
$f->groups["gz"] = $f->get_Buttons(array("fields" => $f->fields["submit"] . $f->fields["cancel"]));
//[build]---------------------------------------------------------------------------------------------------------------
$card = $b->get_Card("create", array(
    "title" => lang("Agreements.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
