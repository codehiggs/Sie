...
$r["place_of_residence"] = $row["place_of_residence"];
...
$r["place_of_birth"] = $row["place_of_birth"];
...
$program = $mprograms->get_Program($r["program"]);
...
$f->fields["date_of_birth"] = $f->get_FieldView("date_of_birth", array("value" => $r["date_of_birth"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["address"] = $f->get_FieldView("address", array("value" => $r["address"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
$f->fields["place_of_residence"] = $f->get_FieldView("place_of_residence", array("value" => $r["place_of_residence"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["place_of_birth"] = $f->get_FieldView("place_of_birth", array("value" => $r["place_of_birth"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->groups["g06"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["phone"] . $f->fields["mobile"] . $f->fields["date_of_birth"])));
$f->groups["g07"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["address"] . $f->fields["place_of_residence"] . $f->fields["neighborhood"])));
...
$f->groups["g10"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["place_of_birth"] . $f->fields["blood_type"] . $f->fields["marital_status"])));
