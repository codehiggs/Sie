...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Spaces.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Spaces.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Spaces.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Spaces.edit-noexist-message"), $d['space']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
