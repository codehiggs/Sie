...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["version"] = $f->get_Value("version", pk());
...
$back = "/sie/grids/view/{$oid}";
$stauses = array(
    array("value" => "", "label" => "- Seleccione una opción"),
    array("value" => "ACTIVE", "label" => "Activa"),
    array("value" => "INACTIVE", "label" => "Inactiva"),
);
//[fields]----------------------------------------------------------------------------------------------------------------
$f->fields["version"] = $f->get_FieldText("version", array("value" => $r["version"], "proportion" => "col-md-4 col-sm-12 col-12", "readonly" => true));
$f->fields["grid"] = $f->get_FieldText("grid", array("value" => $r["grid"], "proportion" => "col-md-4 col-sm-12 col-12", "readonly" => true));
...
$f->fields["status"] = $f->get_FieldSelect("status", array("selected" => $r["status"], "data" => $stauses, "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
//[groups]----------------------------------------------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["version"] . $f->fields["grid"] . $f->fields["status"])));
...
$card = $b->get_Card("create", array(
    "title" => lang("Versions.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
