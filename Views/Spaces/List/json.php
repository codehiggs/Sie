 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Spaces\List\json.php]
...
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["space"]}";
    $editor = "{$component}/edit/{$item["space"]}";
    $deleter = "{$component}/delete/{$item["space"]}";
    ...
    $row["area"] = $item["area"];
    $row["static_capacity"] = $item["static_capacity"];
    $row["dynamic_capacity"] = $item["dynamic_capacity"];
    $row["tv"] = $item["tv"];
    $row["split_wall"] = $item["split_wall"];
    $row["split_ceiling"] = $item["split_ceiling"];
    $row["videobeam"] = $item["videobeam"];
