...
$asuccess = "sie/agreements-edit-success-message.mp3";
$anoexist = "sie/agreements-edit-noexist-message.mp3";
//[build]---------------------------------------------------------------------------------------------------------------
if (is_array($row)) {
    $edit = $model->update($d['agreement'], $d);
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Agreements.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Agreements.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Agreements.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Agreements.edit-noexist-message"), $d['agreement']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
