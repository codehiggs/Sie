 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Qualifications\Creator\validator.php]
...
//[Request]-----------------------------------------------------------------------------
//$f->set_ValidationRule("qualification","trim|required");
//$f->set_ValidationRule("teacher","trim|required");
//$f->set_ValidationRule("score","trim|required");
//$f->set_ValidationRule("weighting","trim|required");
//$f->set_ValidationRule("author","trim|required");
//$f->set_ValidationRule("created_at","trim|required");
//$f->set_ValidationRule("update_at","trim|required");
//$f->set_ValidationRule("delete_at","trim|required");
//[Validation]-----------------------------------------------------------------------------
if ($f->run_Validation()) {
