...
$table = $bootstrap->get_DynamicTable(array(
    'id' => 'table-' . lpk(),
    'data-url' => '/sie/api/students/json/list/' . lpk(),
    'buttons' => array(
        'create' => array('icon' => ICON_ADD, 'text' => lang('App.Create'), 'href' => '/sie/students/create/' . lpk(), 'class' => 'btn-secondary'),
    ),
    'cols' => array(
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang('Students.list-title'),
    "header-back" => $back,
    "alert" => array(
        'type' => 'info',
        'title' => lang('App.Remember'),
        'message' => lang("Students.rol-info")
    ),
    "content" => $table,
));
echo($card);
