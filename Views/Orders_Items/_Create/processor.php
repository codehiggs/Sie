...
/**
* █ ---------------------------------------------------------------------------------------------------------------------
* █ ░FRAMEWORK                                  2024-07-08 09:57:24
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Orders\Items\Creator\processor.php]
...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "text-class" => "text-center",
        "text" => sprintf(lang("Orders.create-success-message"),$d['item']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" =>$asuccess,
    ));
