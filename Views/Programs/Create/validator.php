...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 10:27:34
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Programs\Creator\validator.php]
...
$f->set_ValidationRule("snies", "trim|required");
$f->set_ValidationRule("ies", "trim|required");
$f->set_ValidationRule("ies_parent", "trim|required");
$f->set_ValidationRule("credits", "trim|required");
$f->set_ValidationRule("resolution", "trim|required");
$f->set_ValidationRule("resolution_date", "trim|required");
$f->set_ValidationRule("resolution_execution", "trim|required");
$f->set_ValidationRule("evaluation", "trim|required");
$f->set_ValidationRule("groups", "trim|required");
$f->set_ValidationRule("preregistration", "trim|required");
