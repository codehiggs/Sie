...
//[Query]---------------------------------------------------------------------------------------------------------------
$list = $model->get_ListAdmitted($limit, $offset, $search);
$recordsTotal = $model->get_TotalAdmitted($search);
...
foreach ($list as $item) {
    ...
    $options = $bootstrap::get_BtnGroup('options', array('content' => array($lbilling, $lnotifier, $leditor)));
