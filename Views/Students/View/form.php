...
$f->fields["cancel"] = $f->get_Cancel("cancel", array("href" => "/sie/students/list/" . lpk(), "text" => lang("App.Continue"), "type" => "secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
...
$card = $bootstrap->get_Card("card-view-service", array(
    ...
    "header-back" => $back,
    "header-edit" => "/sie/students/edit/" . lpk() . "/" . $oid,
    "content" => $f,
));
echo($card);
?>