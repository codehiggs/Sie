 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Pensums\List\json.php]
...
//[Asignations]---------------------------------------------------------------------------------------------------------
$data = array();
$component = '/sie/pensums';
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["pensum"]}";
    $editor = "{$component}/edit/{$item["pensum"]}";
    $deleter = "{$component}/delete/{$item["pensum"]}";
    ...
    //[Fields]----------------------------------------------------------------------------------------------------------
    $row["pensum"] = $item["pensum"];
    $row["reference"] = $item["reference"];
    $row["program"] = $item["program"];
    $row["module"] = $item["module"];
    $row["level"] = $item["level"];
    $row["credits"] = $item["credits"];
    $row["weekly_hourly_intensity"] = $item["weekly_hourly_intensity"];
    $row["hourly_intensity"] = $item["hourly_intensity"];
