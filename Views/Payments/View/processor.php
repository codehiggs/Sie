...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Payments.view-success-title"),
        'text' => lang("Payments.view-success-message"),
    ...
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Payments.view-noexist-title"),
        'text' => lang("Payments.view-noexist-message"),
        'footer-class' => 'text-center',
