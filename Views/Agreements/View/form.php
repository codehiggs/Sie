...
$r["headquarters"] = $row["headquarters"];
...
$f->fields["headquarters"] = $f->get_FieldView("headquarters", array("value" => $r["headquarters"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/sie/agreements/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["agreement"] . $f->fields["name"] . $f->fields["description"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["country"] . $f->fields["region"] . $f->fields["city"])));
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["institution"] . $f->fields["headquarters"] . $f->fields["resolution"])));
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Agreements.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
