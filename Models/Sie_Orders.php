...
class Sie_Orders extends Model
{
    ...
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                ...
                'ticket' => ['type' => 'INT', 'constraint' => 10, 'null' => FALSE],
                'parent' => ['type' => 'INT', 'constraint' => 10, 'null' => FALSE],
                'period' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'total' => ['type' => 'DOUBLE', 'constraint' => '10,2', 'default' => 0.00, 'null' => FALSE],
                'paid' => ['type' => 'DOUBLE', 'constraint' => '10,2', 'default' => 0.00, 'null' => FALSE],
                'status' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'type' => ['type' => 'ENUM', 'constraint' => ['NORMAL', 'CREDIT'], 'default' => 'NORMAL',],
                'date' => ['type' => 'DATE', 'null' => FALSE],
                'time' => ['type' => 'TIME', 'null' => FALSE],
                'expiration' => ['type' => 'DATE', 'null' => FALSE],
    ...
    {
        $row = $this->where($this->primaryKey, $order)->first();
        if (is_array($row)) {
            return ($row);
        } else {
            return false;
