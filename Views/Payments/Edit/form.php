...
$r["payment"] = $f->get_Value("payment", $row["payment"]);
$r["record_type"] = $f->get_Value("record_type", $row["record_type"]);
...
$r["payment_origin"] = $f->get_Value("payment_origin", $row["payment_origin"]);
$r["payment_methods"] = $f->get_Value("payment_methods", $row["payment_methods"]);
$r["operation_number"] = $f->get_Value("operation_number", $row["operation_number"]);
$r["authorization"] = $f->get_Value("authorization", $row["authorization"]);
$r["financial_entity"] = $f->get_Value("financial_entity", $row["financial_entity"]);
$r["branch"] = $f->get_Value("branch", $row["branch"]);
$r["sequence"] = $f->get_Value("sequence", $row["sequence"]);
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Payments.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
