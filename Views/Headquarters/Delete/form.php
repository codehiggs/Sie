...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 09:13:55
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Headquarters\Delete\form.php]
...
$r = $model->get_Headquarter($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Headquarters.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Headquarters.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Headquarters.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
