...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-04-30 10:21:30
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Products\Creator\validator.php]
...
//[Request]-----------------------------------------------------------------------------
$f->set_ValidationRule("product", "trim|required");
...
$f->set_ValidationRule("value", "trim|required|numeric");
$f->set_ValidationRule("taxes", "trim|required|numeric");
