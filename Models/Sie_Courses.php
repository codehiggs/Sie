 ...
 */
class Sie_Courses extends Model
{
    ...
    private function exec_TableRegenerate()
    {
        if (!$this->get_TableExist()) {
            ...
            $fields = [
                'course' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                ...
                'maximum_quota' => ['type' => 'INT', 'constraint' => 10, 'null' => FALSE],
                'start' => ['type' => 'DATE', 'null' => FALSE],
                'end' => ['type' => 'DATE', 'null' => FALSE],
                'period' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'space' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'author' => ['type' => 'VARCHAR', 'constraint' => 13, 'null' => FALSE],
                'status' => ['type' => 'ENUM', 'constraint' => ['ACTIVE', 'CLOSED', 'CANCELED'], 'default' => 'ACTIVE',],
    ...
    public function get_Course($course): false|array
    {
