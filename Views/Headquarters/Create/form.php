...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 09:10:56
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Headquarters\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["headquarter"] = $f->get_Value("headquarter", pk());
...
$card = $b->get_Card("create", array(
    "title" => lang("Headquarters.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
