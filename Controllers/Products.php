...
class Products extends ModuleController
{
    ...
    {
        $url = base_url('sie/products/home/' . lpk());
    ...
    public function home(string $rnd)
    {
        ...
        $this->component = $this->views . '\Products\Home';
    ...
    public function view(string $oid)
    {
        ...
        $this->component = $this->views . '\Products\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd)
    {
        ...
        $this->component = $this->views . '\Products\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd)
    {
        ...
        $this->component = $this->views . '\Products\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid)
    {
        ...
        $this->component = $this->views . '\Products\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Products\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
