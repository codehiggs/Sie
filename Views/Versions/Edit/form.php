...
$f->fields["grid"] = $f->get_FieldText("grid", array("value" => $r["grid"], "proportion" => "col-md-6 col-sm-12 col-12", "readonly" => true));
...
$card = $bootstrap->get_Card("create", array(
    "title" => lang("Versions.edit-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
