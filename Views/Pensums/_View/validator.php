 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Pensums\Editor\validator.php]
...
* -----------------------------------------------------------------------------
*/
$f->set_ValidationRule("pensum", "trim|required");
...
$f->set_ValidationRule("weekly_hourly_intensity", "trim|required");
$f->set_ValidationRule("hourly_intensity", "trim|required");
...
if ($f->run_Validation()) {
    ...
    $smarty->assign("title", lang("Pensums.view-errors-title"));
    $smarty->assign("message", lang("Pensums.view-errors-message"));
    $smarty->assign("errors", $errors);
    $smarty->assign("continue", null);
    $smarty->assign("voice", "sie/pensums-view-errors-message.mp3");
