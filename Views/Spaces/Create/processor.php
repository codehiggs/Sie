...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 11:14:03
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Spaces\Creator\processor.php]
...
$asuccess = "sie/spaces-create-success-message.mp3";
$aexist = "sie/spaces-create-exist-message.mp3";
if (is_array($row)) {
    $c = $bootstrap->get_Card("duplicate", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Spaces.create-duplicate-title"),
        "text-class" => "text-center",
        "text" => lang("Spaces.create-duplicate-message"),
    ...
    $c = $bootstrap->get_Card("success", array(
        "class" => "card-success",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Spaces.create-success-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Spaces.create-success-message"), $d['space']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $asuccess,
    ));
