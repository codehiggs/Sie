...
//$edit = $model->update($d);
    $c = $bootstrap->get_Card('warning', array(
        ...
        'title' => lang("Courses.view-success-title"),
        'text' => lang("Courses.view-success-message"),
    ...
    $c = $bootstrap->get_Card('success', array(
        ...
        'icon' => 'fa-duotone fa-triangle-exclamation',
        'text-class' => 'text-center',
        'title' => lang("Courses.view-noexist-title"),
        'text' => lang("Courses.view-noexist-message"),
        'footer-class' => 'text-center',
