 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Discounts\Delete\form.php]
...
$r = $model->get_Discount($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Discounts.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Discounts.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Discounts.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
