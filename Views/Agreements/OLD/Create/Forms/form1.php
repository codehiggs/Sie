            ...
            xhr.onload = function () {
                if (this.status == 200) {
                    ...
                    if (data.place_of_birth) {
                        document.getElementById('<?php echo($fid);?>_place_of_birth').value = data.place_of_birth;
                    }
                    if (data.address) {
                        document.getElementById('<?php echo($fid);?>_address').value = data.address;
                    }
                    if (data.place_of_residence) {
                        document.getElementById('<?php echo($fid);?>_place_of_residence').value = data.place_of_residence;
                    }
