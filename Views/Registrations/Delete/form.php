 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Registrations\Delete\form.php]
...
$r = $mregistrations->get_Registration($oid);
$name = urldecode($r["first_name"] . " " . $r["second_name"] . $r["first_surname"] . " " . $r["second_surname"]);


$message = sprintf(lang("Registrations.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Registrations.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Registrations.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
