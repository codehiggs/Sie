...
* █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Orders\List\json.php]
...
foreach ($list as $item) {
	//[Buttons]---------------------------------------------------------------------------------------------------------
	$viewer = "{$component}/view/{$item["order"]}";
	$editor = "{$component}/edit/{$item["order"]}";
	$deleter = "{$component}/delete/{$item["order"]}";
	...
	$row["date"] =$item["date"];
	$row["time"] =$item["time"];
	$row["expiration"] =$item["expiration"];
