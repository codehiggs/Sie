...
if (is_array($row)) {
    ...
    $c = $bootstrap->get_Card("success", array(
        ...
        "title" => lang("Courses.edit-success-title"),
        "text-class" => "text-center",
        "text" => lang("Courses.edit-success-message"),
    ...
    $c = $bootstrap->get_Card("warning", array(
        "class" => "card-warning",
        "icon" => "fa-duotone fa-triangle-exclamation",
        "title" => lang("Courses.edit-noexist-title"),
        "text-class" => "text-center",
        "text" => sprintf(lang("Courses.edit-noexist-message"), $d['course']),
        "footer-continue" => $l["back"],
        "footer-class" => "text-center",
        "voice" => $anoexist,
    ));
