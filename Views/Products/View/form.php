...
//[Fields]-----------------------------------------------------------------------------
$f->fields["product"] = $f->get_FieldView("product", array("value" => $r["product"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["taxes"] = $f->get_FieldView("taxes", array("value" => $r["taxes"], "proportion" => "col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"));
...
$f->fields["edit"] = $f->get_Button("edit", array("href" => "/sie/products/edit/" . $oid, "text" => lang("App.Edit"), "class" => "btn btn-secondary", "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 padding-right"));
//[Groups]-----------------------------------------------------------------------------
$f->groups["g1"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["product"] . $f->fields["reference"] . $f->fields["name"])));
$f->groups["g2"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["description"] . $f->fields["status"] . $f->fields["value"])));
$f->groups["g3"] = $f->get_Group(array("legend" => "", "fields" => ($f->fields["taxes"] . $f->fields["type"])));
//[Buttons]-----------------------------------------------------------------------------
...
$card = $bootstrap->get_Card("card-view-service", array(
    "title" => lang("Products.view-title"),
    "header-back" => $back,
    "content" => $f,
));
echo($card);
