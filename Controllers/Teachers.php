 ...
 *
 */
class Teachers extends ModuleController
{
    ...
    {
        $url = base_url('sie/teachers/home/' . lpk());
    ...
    public function view(string $oid)
    {
        ...
        $this->component = $this->views . '\Teachers\View';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function list(string $rnd)
    {
        ...
        $this->component = $this->views . '\Teachers\List';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function create(string $rnd)
    {
        ...
        $this->component = $this->views . '\Teachers\Create';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function importer(string $rnd)
    {
        ...
        $this->component = $this->views . '\Teachers\Importer';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function edit(string $oid)
    {
        ...
        $this->component = $this->views . '\Teachers\Edit';
        return (view($this->viewer, $this->get_Array()));
    }
    ...
    public function delete(string $oid)
    {
        ...
        $this->component = $this->views . '\Teachers\Delete';
        return (view($this->viewer, $this->get_Array()));
    }
