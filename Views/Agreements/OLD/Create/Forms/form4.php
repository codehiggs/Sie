...
$card = $bootstrap->get_Card("create", array(
    ...
    "alert" => array(
        "type" => "info",
        "title" => "Recuerda",
        "message" => "Selecciona cada elemento de la lista desplegable que encontrarás a continuación y carga el documento correspondiente. Recuerda que es necesario cargar todos los documentos para completar el proceso.",
    ),
    "content" => $code,
    "header-back" => $back
));
