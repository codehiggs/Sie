 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Orders\Creator\validator.php]
...
$f->set_ValidationRule("installments", "trim|required|numeric");
$f->set_ValidationRule("ticket", "trim|required");
//$f->set_ValidationRule("parent","trim|required");
//$f->set_ValidationRule("period","trim|required");
//$f->set_ValidationRule("total","trim|required");
//$f->set_ValidationRule("paid","trim|required");
...
//$f->set_ValidationRule("expiration","trim|required");
