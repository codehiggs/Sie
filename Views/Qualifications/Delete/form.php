...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-08 10:36:50
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Qualifications\Delete\form.php]
...
$r = $model->get_Qualifications($oid);
$name = urldecode($r["name"]);
$message = sprintf(lang("Qualifications.delete-message"), $name);
...
$card = $bootstrap->get_Card("delete-{$oid}", array(
    "class" => "card-info",
    "icon" => ICON_WARNING,
    "title" => sprintf(lang("Qualifications.delete-title"), $name),
    "text-class" => "text-center",
    "text" => sprintf(lang("Qualifications.delete-message"), $name),
    "content" => $f,
    "header-back" => $back
));
echo($card);
