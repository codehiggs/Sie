...
/**
 * █ ---------------------------------------------------------------------------------------------------------------------
 * █ ░FRAMEWORK                                  2024-08-06 16:34:04
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Enrolleds\Creator\form.php]
...
//[vars]----------------------------------------------------------------------------------------------------------------
$r["enrolled"] = $f->get_Value("enrolled", pk());
$r["course"] = $f->get_Value("course", $oid);
$r["student"] = $f->get_Value("student");
$r["status"] = $f->get_Value("status");
$r["author"] = $f->get_Value("author", safe_get_user());
$r["created_at"] = $f->get_Value("created_at");
$r["updated_at"] = $f->get_Value("updated_at");
$r["deleted_at"] = $f->get_Value("deleted_at");
$back = "/sie/courses/view/$oid";
...
$f->fields["student"] = $f->get_FieldSelect("student", array("selected" => $r["student"], "data" => $students, "proportion" => "col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12"));
...
$card = $b->get_Card("create", array(
    "title" => lang("Enrolleds.create-title"),
    "content" => $f,
    "header-back" => $back
));
echo($card);
