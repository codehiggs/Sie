 ...
 * █ ░█▀▀█ █▀▀█ █▀▀▄ █▀▀ ░█─░█ ─▀─ █▀▀▀ █▀▀▀ █▀▀ [App\Modules\Sie\Views\Courses\List\json.php]
...
foreach ($list as $item) {
    //[Buttons]---------------------------------------------------------------------------------------------------------
    $viewer = "{$component}/view/{$item["course"]}";
    $editor = "{$component}/edit/{$item["course"]}";
    $deleter = "{$component}/delete/{$item["course"]}";
    ...
    $details = "<b>Nombre</b>: {$item["name"]}";
    $details .= "<br><b>Descripción</b>: {$item["description"]}";
    $details .= "<br><b>Inicio</b>: {$item["start"]} <b>Finalización</b>: {$item["end"]}";
    //[Fields]----------------------------------------------------------------------------------------------------------
    ...
    $row["maximum_quota"] = $item["maximum_quota"];
